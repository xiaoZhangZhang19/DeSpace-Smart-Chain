...
function transfer(string from_asset_account, string to_asset_account, uint256 amount) public returns(int256)`} />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/asset_contract.png" alt="资产合约接口设计" className="my-4 rounded-sm border border-white/10 w-full block" />
...
# Java HotSpot(TM) 64-Bit Server VM (build 14.0.2+12-46, mixed mode, sharing)`} />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/install_java_intellij.gif" alt="安装IntelliJ IDE" className="my-4 rounded-sm border border-white/10 w-full block" />

          <H3 id="s4-step2">第二步. 创建一个Java工程</H3>
          <P>在IntelliJ IDE中创建一个gradle项目，勾选Gradle和Java，并输入工程名<IC>asset-app</IC>。</P>

          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/create_app_mid.gif" alt="创建Java工程" className="my-4 rounded-sm border border-white/10 w-full block" />
...
$ tar -zxf asset-app.tar.gz`} />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/download_asset.png" alt="下载asset-app" className="my-4 rounded-sm border border-white/10 w-full block" />
...
implementation ('org.fisco-bcos.java-sdk:fisco-bcos-java-sdk:2.9.1')`} />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/import_sdk.png" alt="引入Java SDK" className="my-4 rounded-sm border border-white/10 w-full block" />
...
dependencies {
    ...
    implementation spring
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/import_spring.png" alt="引入Spring框架" className="my-4 rounded-sm border border-white/10 w-full block" />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/config.png" alt="applicationContext.xml配置" className="my-4 rounded-sm border border-white/10 w-full block" />
...
$ cp -r nodes/127.0.0.1/sdk/* asset-app/src/main/resources/conf`} />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/copy_cert.png" alt="拷贝节点证书" className="my-4 rounded-sm border border-white/10 w-full block" />
...
cp console/contracts/sdk/java/org/fisco/bcos/asset/contract/Asset.java asset-app/src/main/java/org/fisco/bcos/asset/contract/Asset.java`} />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/copy_contract.png" alt="引入合约Java类" className="my-4 rounded-sm border border-white/10 w-full block" />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/asset_client.png" alt="AssetClient代码" className="my-4 rounded-sm border border-white/10 w-full block" />
...
function usage() 
{
    ...
    *)
    ...
    java -Djdk.tls.namedGroups="secp256k1" -cp 'apps/*:conf/:lib/*' org.fisco.bcos.asset.client.AssetClient $@`} />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/make_sh.png" alt="创建运行脚本" className="my-4 rounded-sm border border-white/10 w-full block" />
...
log4j.appender.stdout.layout.ConversionPattern=[%p] [%-d{yyyy-MM-dd HH:mm:ss}] %C{1}.%M(%L) | %m%n`} />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/config_log.png" alt="配置log4j" className="my-4 rounded-sm border border-white/10 w-full block" />
...
jar {
    ...
    doLast {
        ...
        copy {
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/conf_jar_log.png" alt="配置Jar与日志" className="my-4 rounded-sm border border-white/10 w-full block" />
...
account Bob, value 150000`} />
          ...
          <img src="https://fisco-bcos-documentation.readthedocs.io/zh-cn/latest/_images/test.png" alt="运行测试结果" className="my-4 rounded-sm border border-white/10 w-full block" />
