...
bash build_chain.sh -l 127.0.0.1:4 -p 30300,20200,8545`} />
          ...
          <H3 id="se-step3">第三步. 启动Key Manager</H3>
          ...
          <H3 id="se-step4">第四步. 配置dataKey</H3>
...
[INFO] "nodes/127.0.0.1/node0/conf/node.key" encrypted!`} />
          ...
          <H3 id="se-step6">第六步. 节点运行</H3>
          <CodeBlock language="bash" code={`cd nodes/127.0.0.1/node0/
./start.sh`} />

          <H3 id="se-step7">第七步. 正确性判断</H3>
